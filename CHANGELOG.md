...
- Все 201 уроков теперь публикуются как самостоятельные статические страницы сайта:
  полный учебный текст, pre/post-квиз, тесты, reference-код, артефакты, прогресс и
  навигация между уроками доступны без обязательного перехода на GitHub. Sitemap и
  structured data расширены до каждой страницы урока.
