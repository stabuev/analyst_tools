...
| 04 | [SQL и DuckDB](phases/04-sql-and-duckdb) | core | 03 | 15-21 |
...
- **Аналитик данных**: `00-10 -> 17 -> 18` (~161-228 часов)
- **Продуктовый аналитик**: `00-10 -> 13 -> 17 -> 18` (~173-244 часов)
- **Аналитик временных рядов**: `00-09 -> 14 -> 17 -> 18` (~159-226 часов)
- **Analytics Engineer**: `00-07 -> 11-12 -> 17 -> 18` (~149-212 часов)
- **ML-аналитик**: `00-07 -> 09 -> 12 -> 15-18` (~175-246 часов)
- **Полный маршрут**: `00-18` (~239-330 часов)
...
| 05 | [Сборка, сортировка и согласованность массивов](phases/02-numpy/05-composition-and-ordering) | complete |
| 06 | [Агрегации и оси расчета](phases/02-numpy/06-aggregations) | complete |
| 07 | [Broadcasting без магии](phases/02-numpy/07-broadcasting) | complete |
| 08 | [Случайность и воспроизводимые симуляции](phases/02-numpy/08-random-simulations) | complete |
| 09 | [Векторизация и производительность](phases/02-numpy/09-vectorization) | complete |
| 10 | [Численная точность и сравнение результатов](phases/02-numpy/10-numerical-precision) | complete |
