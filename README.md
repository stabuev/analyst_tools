...
тестами, reference-кодом и артефактами. Исходники standalone static-сайта находятся в
[`site/`](site/).
...
`code/` и `outputs/` содержат reference implementation, а не обязательную заготовку для
редактирования. Достаточный цикл бесплатного self-paced курса:
...
3. Запустите готовый пример и сравните результат со своей моделью.
4. Выполните хотя бы один сценарий из `Сломайте это` и объясните причину сбоя.
5. Запустите тесты урока и выполните хотя бы одно упражнение.
...
| Аналитик временных рядов | `0-9`, `14`, `17`, `18` | 158-222 | Прогноз, backtesting, интервалы и anomaly policy |
