...
**Вариант B — открыть сайт.** [Публичная версия курса](https://stabuev.github.io/analyst_tools/)
содержит дорожную карту, маршруты, каталог и GitHub-ссылки на готовые уроки. Исходники
standalone static-сайта находятся в [`site/`](site/).
