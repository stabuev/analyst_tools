...
завершены фазы `0-5`, фаза `06` полностью спроектирована; следующий этап — разработка
урока `06/01` «Вопрос раньше графика». Точная готовность и следующий шаг указаны в
