...
разрабатываются последовательно, начиная с фаз `0-2`. Точная готовность и следующий урок
указаны в [`docs/PROJECT_STATUS.md`](docs/PROJECT_STATUS.md), заметные изменения — в
