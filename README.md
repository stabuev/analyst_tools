...
**Вариант B — клонировать и запускать.**
...
**Вариант C — определить уровень.** В агенте, который поддерживает project skills:
...
Архитектура курса и полная дорожная карта зафиксированы. Следующий этап - разработка
фаз `0-2`: содержание уроков, исполняемый код, тесты, квизы и первые артефакты.
