...
**Ветка:** `main`
**Базовый коммит перед текущим этапом:** `47039480` — расширенное дополнительное чтение урока выбора и фильтрации pandas
...
В текущем незакоммиченном этапе переработан урок `03/04` «Производные столбцы:
