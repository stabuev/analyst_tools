...
**Ветка:** `main`
**Базовый коммит перед текущим этапом:** `10194d94` — переработка урока GroupBy pandas
...
В текущем незакоммиченном этапе переработано основное содержание урока `03/07` «Pivot,
