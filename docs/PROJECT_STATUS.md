...
**Ветка:** `main`
**Базовый коммит перед текущим этапом:** `3ec207d6` — переработанный урок выбора и фильтрации pandas
...
В текущем незакоммиченном этапе дополнительное чтение `03/03` расширено с трех до десяти
