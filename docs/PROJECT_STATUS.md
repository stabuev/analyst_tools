...
**Ветка:** `main`
**Базовый коммит перед текущим этапом:** `b7130460` — переработанный второй урок pandas
...
В текущем незакоммиченном этапе переработан урок `03/03` «Выбор строк и столбцов» с
...
`loc`-присваиванием. Практика покрыта 19 behavioral tests. Путеводитель фазы синхронизирован;
дополнительное чтение намеренно оставлено для отдельного следующего шага.
