...
В текущем незакоммиченном этапе переработан нынешний урок `03/10` «Строки и
категориальные типы».
...
ordered-сортировку. Время урока увеличено с 75 до 105 минут; дополнительное чтение пока
не переработано.
