...
- `04/11`–`04/12` поставляют Python runner и сравнение `EXPLAIN ANALYZE`;
...
Содержание и дополнительное чтение `04/10` о когортах в SQL переработаны; следующий шаг —
зафиксировать урок коммитом, затем перейти к аудиту `04/11`. К `04/11` пока не
переходили.
