...
- `contract.json`, `excel_spec.json`, `json_contract.json`, `html_contract.json`,
  `db_contract.json`, `parquet_schema.json`, `arrow_exchange_contract.json`,
  `partition_layout_contract.json` и `delivery_contract.json` — явные договоры форматов,
  схем, результатов чтения или записи, in-memory маршрутов обмена, partitioned layout и
  интеграционной поставки.
