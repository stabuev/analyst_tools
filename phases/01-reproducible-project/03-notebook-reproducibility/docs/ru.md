...
**Тип:** Build
**Треки:** Core
**Пререквизиты:** 01/02 — Jupyter, kernels и состояние
**Время:** ~60 минут
...
python3 -m unittest discover \
  -s phases/01-reproducible-project/03-notebook-reproducibility/tests \
  -p "test_*.py" -v
```
...
```bash
python3 phases/01-reproducible-project/03-notebook-reproducibility/code/main.py
```
...
```bash
jupyter execute \
  phases/01-reproducible-project/03-notebook-reproducibility/outputs/reproducible_analysis.ipynb
```
