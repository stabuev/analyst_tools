...
```bash
python3 phases/00-entry-and-tools/06-secrets-and-sensitive-data/outputs/secure_project.py \
...
python3 -m unittest discover \
  -s phases/00-entry-and-tools/06-secrets-and-sensitive-data/tests \
  -p "test_*.py" -v
```
...
```bash
python3 phases/00-entry-and-tools/06-secrets-and-sensitive-data/code/main.py
```
