...
Перед уроками откройте [пошаговый путеводитель фазы](../../docs/phase-07-learning-guide.md). Он связывает короткие уроки в один сквозной пример, показывает ожидаемые промежуточные результаты и точки самопроверки.
