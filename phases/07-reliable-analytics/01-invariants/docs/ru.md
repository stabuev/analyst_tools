...
Если это ваше первое знакомство с системными проверками, используйте
[`../../../../docs/phase-07-learning-guide.md`](../../../../docs/phase-07-learning-guide.md):
он показывает один заказный pipeline от словесного инварианта до атомарной публикации.
